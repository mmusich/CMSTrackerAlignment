...
#ifndef OfflineValidationTreeAnalysis_v2_h
#define OfflineValidationTreeAnalysis_v2_h
...
class OfflineValidationTreeAnalysis_v2 {
public :
 ...
 //TkOffTreeVariables *TkOffTreeVariables;
   ...
   OfflineValidationTreeAnalysis_v2(TString filename="",TString theName="");
   virtual ~OfflineValidationTreeAnalysis_v2();
...
#ifdef OfflineValidationTreeAnalysis_v2_cxx
OfflineValidationTreeAnalysis_v2::OfflineValidationTreeAnalysis_v2(TString filename,TString theName) : fChain(0) 
{
...
OfflineValidationTreeAnalysis_v2::~OfflineValidationTreeAnalysis_v2()
{
  fOutputFile->Close();
  if (!fChain) return;
...
/*--------------------------------------------------------------------*/
Int_t OfflineValidationTreeAnalysis_v2::GetEntry(Long64_t entry)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
Long64_t OfflineValidationTreeAnalysis_v2::LoadTree(Long64_t entry)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::Init(TTree *tree)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
Bool_t OfflineValidationTreeAnalysis_v2::Notify()
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::Show(Long64_t entry)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::makeNicePlotStyle(TH1F *hist)
/*--------------------------------------------------------------------*/
{
  hist->SetLineWidth(2);
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::makeNice2DPlotStyle(TH2F *hist)
/*--------------------------------------------------------------------*/
{
  hist->SetLineWidth(3);
  hist->GetXaxis()->CenterTitle(true);
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::makeNiceProfileStyleAndColor(TProfile *hist,int color)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::makeNicePlotStyleAndColor(TH1F *hist,int color)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::setStyle(TString palettename)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
TPaveText* OfflineValidationTreeAnalysis_v2::addNiceTLegend(TObjArray *histos)
/*--------------------------------------------------------------------*/
{
...
/*--------------------------------------------------------------------*/
void OfflineValidationTreeAnalysis_v2::makeNiceCanv(TCanvas *c)
/*--------------------------------------------------------------------*/
{
...
#endif // #ifdef OfflineValidationTreeAnalysis_v2_Cxx
