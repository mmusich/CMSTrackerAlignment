...
void generalizedSuperImpose(TString namesandlabels,Int_t nOfFiles){
  ...
  for (Int_t kF=0; kF < 2; kF++) { 
	...
	if(kF==0 && kV==0) leg->AddEntry(h1xBPix[i][kF][kV],legs[i]);
      ...
      cBPixX[kF][kV]->SaveAs(Form("cBPixX_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0)h1xFPix[i][kF][kV]->Draw("");
      ...
      cFPixX[kF][kV]->SaveAs(Form("cFPixX_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1yBPix[i][kF][kV]->Draw("");
      ...
      cBPixY[kF][kV]->SaveAs(Form("cBPixY_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1yFPix[i][kF][kV]->Draw("");
      ...
      cFPixY[kF][kV]->SaveAs(Form("cFPixY_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1TIB[i][kF][kV]->Draw("");
      ...
      cTIB[kF][kV]->SaveAs(Form("cTIB_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1TID[i][kF][kV]->Draw("");
      ...
      cTID[kF][kV]->SaveAs(Form("cTID_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1TOB[i][kF][kV]->Draw("");
      ...
      cTOB[kF][kV]->SaveAs(Form("cTOB_%s_Vs_%s.png",folders[kF],vars[kV]));
	...
	if(i==0) h1TEC[i][kF][kV]->Draw("");
      ...
      cTEC[kF][kV]->SaveAs(Form("cTEC_%s_Vs_%s.png",folders[kF],vars[kV]));
    }
  }
}
