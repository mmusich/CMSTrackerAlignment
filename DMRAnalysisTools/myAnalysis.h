...
public :
 ...
 //TkOffTreeVariables *TkOffTreeVariables;
   ...
   myAnalysis(TTree *tree=0,TString filename="");
   virtual ~myAnalysis();
...
myAnalysis::myAnalysis(TTree *tree,TString filename) : fChain(0) 
{
...
void myAnalysis::makeNicePlotStyle(TH1F *hist){
  hist->SetLineWidth(2);
...
void myAnalysis::makeNice2DPlotStyle(TH2F *hist){
  hist->GetXaxis()->CenterTitle(true);
  hist->GetYaxis()->CenterTitle(true);
  hist->GetXaxis()->SetTitleFont(42); 
  hist->GetYaxis()->SetTitleFont(42);  
...
void myAnalysis::makeNiceProfileStyleAndColor(TProfile *hist,int color){
...
void myAnalysis::makeNicePlotStyleAndColor(TH1F *hist,int color){
...
void myAnalysis::makeNicePlotStyleA(TH1F *hist){
  hist->SetLineColor(1);
  hist->SetLineStyle(9);
  hist->SetLineWidth(2);
  hist->GetXaxis()->CenterTitle(true);
...
void myAnalysis::makeNicePlotStyleB(TH1F *hist){
  hist->SetLineColor(2);
  hist->SetLineStyle(9);
  hist->SetLineWidth(2);
  hist->GetXaxis()->CenterTitle(true);
...
void myAnalysis::setStyle(TString palettename){
...
TPaveText* myAnalysis::addNiceTLegend(TObjArray *histos){
...
void myAnalysis::makeNiceCanv(TCanvas *c){
